...
export default function Cart() {
    ...
    async function deleteItem(e) {
        ...
        if (userData.email) {
            await fetch(`https://${host}cart/remove_item`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {
    ...
    async function setCountItem(e) {
        ...
        if (userData.email) {
            try {
                await fetch(`https://${host}cart/set_count`, {
                    method: 'PATCH',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    async function onClickApply(e) {
        ...
        items.map(async item => {
            ...
            await fetch(`https://${host}purchase/add_item`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
    ...
    useEffect(() => {
        async function fetchData() {
            const request = await fetch(`https://${host}cart`, {
                method: 'GET',
                credentials: 'include',
            });
            if (request.ok) {
